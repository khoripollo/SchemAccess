...
\def\ctikzactivatevoltagedirections#1{%
    ...
    \ctikzset{#1^/.style = {#1={##1}, \circuitikzbasekey/bipole/voltage/position  = above} }
    \ctikzset{#1>/.style = {#1={##1}, \circuitikzbasekey/bipole/voltage/direction = forward} }
    \ctikzset{#1</.style = {#1={##1}, \circuitikzbasekey/bipole/voltage/direction = backward} }%
}
...
\ctikzset{v label/.style={bipole/voltage/label/name={#1}}}
